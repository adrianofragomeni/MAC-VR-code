...
class DiDeMoDataset(Dataset):
    def __init__(
        ...
        self.subset = subset
        assert self.subset in ["train", "val", "test", "train_test"]

        self.config = config
        video_id_path_dict = {}
        video_id_path_dict["train"] = os.path.join(self.data_path, "train_list.txt")
        video_id_path_dict["train_test"] = os.path.join(self.data_path, "train_list.txt")
        ...
        video_json_path_dict["train_test"] = os.path.join(self.data_path, "train_data.json")
    ...
    def __getitem__(self, feature_idx):
        ...
        visual_concepts_list=ast.literal_eval(self.concepts[video_id][0])
        textual_concepts_list=ast.literal_eval(self.concepts[video_id][1])
        ...
        return pairs_text, pairs_mask, visual_c_ids, visual_c_mask, textual_c_ids, textual_c_mask, video, video_mask, feature_idx, hash(video_id)
